...
all_images_path = "/Users/ltopalis/Library/CloudStorage/GoogleDrive-lazarostop32@gmail.com/Το Drive μου/THESIS/Dataset/MS-COCO/zipFiles/train2017/*"
train2017_template = os.path.join(
    root_folder, 'train2017_template/')
train2017_label = os.path.join(
    root_folder, 'train2017_label/')
train2017_input = os.path.join(
    root_folder, 'train2017_input/')

img_path_list = glob.glob(all_images_path)

if not (os.path.exists(train2017_template)):
    os.makedirs(train2017_template)
if not (os.path.exists(train2017_label)):
    os.makedirs(train2017_label)
if not (os.path.exists(train2017_input)):
    os.makedirs(train2017_input)
...
for img_path in img_path_list:
    ...
    plt.imsave(os.path.join(train2017_input, img_name), square_img)
    ...
    plt.imsave(os.path.join(train2017_template, img_name),
    ...
    with open(os.path.join(train2017_label, f"{img_name[:(len(img_name)-4)]}_label.txt"), 'w') as outfile:
