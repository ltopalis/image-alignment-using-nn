...
from Dataset import DatasemyYaleCroppedB, collate_batch

json_path = 'datasets/myYaleCroppedB/ecc_dataset_index.json'
model_save_path = "pretrained_models/"
fig_save_path = "pretrained_models/images/testing_with_myYaleCroppedB"
batch = 10
...
full_ds = DatasemyYaleCroppedB(json_path)
